...
const CollaboratorsList: React.FC<CollaboratorsListProps> = ({ 
  ...
  // If there are no peers, just show a simple message for the inline mode
  if (displayMode === 'inline' && Object.keys(peers).length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 border border-gray-200 dark:border-gray-700">
        <div className="text-center text-gray-500 dark:text-gray-400 py-2">
          <HiOutlineUsers className="h-6 w-6 mx-auto mb-2" />
  ...
  // Inline display - a simple popup
  if (displayMode === 'inline') {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-72 border border-gray-200 dark:border-gray-700">
  ...
  // Sidebar display - a full height sidebar
  return (
